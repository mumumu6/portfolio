...
type AiCommentTargetKind = Extract<EntryKind, 'work' | 'experience'>

type PublishedAiContent = {
  comments: Array<{
    target: { kind: AiCommentTargetKind; id: string }
    replies: Reply[]
  }>
...
export const getAiReplies = (kind: AiCommentTargetKind, id: string) =>
